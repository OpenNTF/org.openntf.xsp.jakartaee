 ...
 * of the PrimeFaces Showcase DB.
 */
public enum ShowcaseAndModuleProvider {
	;
	
	public static final Collection<TestDatabase> VALS = List.of(TestDatabase.PRIMEFACES_SHOWCASE, TestDatabase.PRIMEFACES_SHOWCASE_MODULE);
