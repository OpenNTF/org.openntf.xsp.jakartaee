...
public interface ELValueConverter {
	 ...
	 */
	default Object preSetValue(final ELContext elContext, final ValueExpression exp, final Object value) {
		return value;
	}
	 ...
	 * @return the filtered value
	 */
	default Object postGetValue(final ELContext elContext, final ValueExpression exp, final Object value) {
		return value;
	}
}
