...
public class NoSQLWeavingHook implements WeavingHook {
	...
	private void processClassScanner(WovenClass c) {
		...
		try {
			...
			String body = """
			{
				return org.eclipse.core.runtime.Platform.getBundle("org.openntf.xsp.jakarta.nosql").loadClass("org.openntf.xsp.nosql.scanner.ComponentModuleClassScanner").getConstructor(new Class[0]).newInstance(new Object[0]);
			}"""; //$NON-NLS-1$
