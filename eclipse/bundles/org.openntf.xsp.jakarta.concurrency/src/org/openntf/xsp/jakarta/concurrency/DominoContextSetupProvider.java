...
public class DominoContextSetupProvider implements ContextSetupProvider {
	...
	@Override
	public ContextHandle saveContext(final ContextService contextService) {
	...
	@Override
	public ContextHandle saveContext(final ContextService contextService, final Map<String, String> contextObjectProperties) {
		ContextHandle handle = new AttributedContextHandle();
		LibraryUtil.findExtensionsSorted(ContextSetupParticipant.class, false)
	...
	@Override
	public ContextHandle setup(final ContextHandle contextHandle) throws IllegalStateException {
		if(shouldSetup()) {
			LibraryUtil.findExtensionsSorted(ContextSetupParticipant.class, false)
