...
public interface DominoTemplate extends DocumentTemplate {
	 ...
	 * @sine 2.6.0
	 */
	<T> Stream<T> viewEntryQuery(String entityName, String viewName, PageRequest pagination, Sort<?> sorts, int maxLevel, boolean docsOnly, ViewQuery viewQuery, boolean singleResult);
	 ...
	 * @sine 2.6.0
	 */
	<T> Stream<T> viewDocumentQuery(String entityName, String viewName, PageRequest pagination, Sort<?> sorts, int maxLevel, ViewQuery viewQuery, boolean singleResult, boolean distinct);
